import asyncio
import logging
import os  # 1. 포트 설정을 위해 os 모듈을 추가했습니다
from flask import Flask  # 2. Render 포트 에러 방지를 위한 flask 추가
...
# 3. Render가 웹 서비스로 인식할 수 있도록 가짜 웹 서버 설정 추가
app = Flask("")
...
if __name__ == "__main__":
  ...
  # 4. Render 포트 에러를 막기 위해 웹 서버와 봇을 동시에 실행합니다.
